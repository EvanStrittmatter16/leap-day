...
<div id="wrapper"> 
    <video id="home1" width="285" poster="images/video.jpg" controls="controls" preload="none"> 
        <source type="video/mp4" src="images/RobotHandWave.mp4" /> 
    </video>
    <video id="home2" width="285" poster="images/video.jpg" controls="controls" preload="none"> 
